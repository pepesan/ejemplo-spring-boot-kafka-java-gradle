...
@Slf4j
@Service
public class NotificationConsumerPartition1 {

    private final List<NotificationMessage> received = new ArrayList<>();

    @KafkaListener(
        groupId = "${spring.application.name}-notifications-p1",
    ...
    public void consume(NotificationMessage notification) {
        log.info("[CONSUMER][P1] notifications partición 1 | id={} | recipient={} | subject={}",
